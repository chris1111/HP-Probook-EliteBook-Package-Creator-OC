...
curl -L https://github.com/chris1111/OCLP-Dev-repos/releases/download/2.1.0/OpenCore-Patcher.pkg.zip -o /$HOME/Desktop/HP-ProBook-EliteBook-Packager/"$APP_NAME"
