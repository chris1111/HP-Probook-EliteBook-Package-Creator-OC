...
curl -L https://github.com/dortania/OpenCore-Legacy-Patcher/releases/download/0.6.6/OpenCore-Patcher-GUI.app.zip -o /$HOME/Desktop/HP-ProBook-EliteBook-Packager/"$APP_NAME"
