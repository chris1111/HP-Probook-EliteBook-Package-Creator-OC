...
- Create Install Media HP Laptop tools « IMPORTANT » without adding file aml (DSDT.aml), (SSDT.aml) in  /EFI / OC / ACPI. Oonly with the two files that are present SSDT-IGPU.aml, SSDT-HMF.aml.
